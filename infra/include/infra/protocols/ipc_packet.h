...
INFRA_API void ipc_packet_handshake_init(struct ipc_base_packet* packet);
...
INFRA_API struct ipc_base_packet* ipc_packet_read(void* socket_handle, ipc_packer_read_t read_cb);
INFRA_API ssize_t ipc_packet_write(struct ipc_base_packet* packet, void* socket_handle, ipc_packer_write_t write_cb);
